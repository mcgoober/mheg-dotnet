...
{
    abstract class MHPresentable : MHIngredient
    {
        public MHPresentable()
        {
            // Empty
        }
        ...
        // Actions.
        public override void Run(MHEngine engine)
        {
        ...
        public virtual void BeginPlaying(MHEngine engine) 
        {
            // Empty
        }

        public virtual void StopPlaying(MHEngine engine) 
        {
            // Empty
        }
    }
