...
{
    class MHObjectRefVar : MHVariable
    {
        protected MHObjectRef m_OriginalValue, m_Value;

        public MHObjectRefVar() 
        {
            m_OriginalValue = new MHObjectRef();
            m_Value = new MHObjectRef();
        }
        ...
        public override void Initialise(MHParseNode p, MHEngine engine)
        {
            ...
            MHParseNode pArg = pInitial.GetNamedArg(ASN1Codes.C_OBJECT_REFERENCE);
        ...
        public override void TestVariable(int nOp, MHUnion parm, MHEngine engine)
        {
            ...
            switch (nOp)
            {
                case TC_Equal: fRes = m_Value.Equal(parm.ObjRef, engine); break;
                case TC_NotEqual: fRes = ! m_Value.Equal(parm.ObjRef, engine); break;
                default: throw new MHEGException("Invalid comparison for object ref");
            }
